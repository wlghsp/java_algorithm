...
public class 예산 {
    // 블로그 참조함. 일단 정렬하고 작은 값부터 더해 나가다가 예산보다 커지면 루프탈출 
    ...
    // 다른 사람 풀이.  budget을 빼나가고 0보다 작아지면 브레이크 
    static int solution2(int[] d, int budget) {
        int answer = 0;
        Arrays.sort(d);
        for (int i = 0; i < d.length; i++) {
            budget -= d[i];
    ...
    public static void main(String[] args) {
        ...
        int budget1 = 9;
        int budget2 = 10;
        System.out.println(solution1(d1, budget1));
        System.out.println(solution2(d2, budget2));
    }
}
